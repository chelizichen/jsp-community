...
<%--                 enctype="multipart/form-data">--%>
                <input type="hidden" name="opr" value="saveUser" />
	            ...
	            <font color="red"></font>
                 ...
                 <%--<div>
                    ...
                    <label for="a_idPicPath">证件照:</label>
                   	<input type="file" name="idPicPath1" id="a_idPicPath"/>
                    <font color="red"></font>
                 </div>  --%>
...
<input type="hidden" id = "path1" value="${pageContext.request.contextPath}" />
