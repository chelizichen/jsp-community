...
<div class="right">
        ...
        <div class="providerAdd">
           <form id="providerForm" name="providerForm" method="post" 
           	action="${pageContext.request.contextPath }/provider/provideraddsave.do" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <label for="a_companyLicPicPath">企业营业执照：</label>
                   	<input type="file" name="company" id="a_companyLicPicPath"/>
                    <font color="red"></font>
                </div>
                 <div>
                	<input type="hidden" id="errorinfo_oc" value="${uploadOcError}"/>
                    <label for="a_orgCodePicPath">组织机构代码证：</label>
                   	<input type="file" name="org" id="a_orgCodePicPath"/>
                    <font color="red"></font>
                </div>
