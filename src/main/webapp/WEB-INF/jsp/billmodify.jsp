...
<div class="right">
        ...
        <div class="providerAdd">
          <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/jsp/billModify.do">
                        ...
                        <c:if test="${providerList != null }">
                            ...
                            <c:forEach var="provider" items="${providerList}">
                                <option value="${provider.id}"
                                        <c:if test="${provider.id eq bill.provider.id}">selected="selected"</c:if> >
